export const CAREER_DATA =  [
  {
    ...
    projects: [
      ...
      },
      {
        ...
        roleDescription: "Optimize and refactor existing codebase using modern React. Implemented fully functional features like listing and saving properties listings from external websites into the CE. Integrate AWS Auth services and a completely new backend API.",
    ...
    projects: [
      {
        ...
        type2: "Customer facing application",
        start: 2022,
        end: 2023,
      ...
      {
        type: "Affiliate Marketing Platform",
        type2: "Data reports application",
        start: 2021,
        end: 2022,
   ...
   }, 
  {
    ...
    projects: [
      {
        type: "Chemicals Company Website",
        start: 2016,
        end: 2019,
